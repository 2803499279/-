...
@interface YZNewHomeThereCell : UITableViewCell

@property (nonatomic, strong) UILabel *Title;

@property (nonatomic, strong) UIImageView *ProductImage;
@property (nonatomic, strong) UIImageView *ProductImageTwo;
@property (nonatomic, strong) UIImageView *ProductImageThere;
