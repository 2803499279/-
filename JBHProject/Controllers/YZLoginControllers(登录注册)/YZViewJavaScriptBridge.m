...
@interface YZViewJavaScriptBridge ()
...
@implementation YZViewJavaScriptBridge
...
+ (id)javascriptBridgeWithDelegate:(id <ViewJavaScriptBridgeDelegate>)delegate {
    YZViewJavaScriptBridge* bridge = [[YZViewJavaScriptBridge alloc] init];
