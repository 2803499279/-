...
//    shareButton.backgroundColor = YZEssentialColor;
...
//    _ListenButton.frame = CGRectMake(10*YZAdapter, 468*YZAdapter, Screen_W - 20*YZAdapter, 42*YZAdapter);
    _ListenButton.frame = CGRectMake(10*YZAdapter, 403*YZAdapter, Screen_W - 20*YZAdapter, 42*YZAdapter);
    ...
    //第二种方法如下:
    _ListenButton.layer.borderColor=YZEssentialColor.CGColor;
