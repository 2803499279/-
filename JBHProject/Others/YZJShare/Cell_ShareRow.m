...
- (UICollectionView *)collectView{
    ...
    [flowLayout setItemSize:CGSizeMake(90*YZAdapter, 90*YZAdapter)];//设置cell的尺寸
    [flowLayout setScrollDirection:UICollectionViewScrollDirectionVertical];//设置其布局方向
    flowLayout.sectionInset = UIEdgeInsetsMake(5, 0, 5, 0);//设置其边界
    flowLayout.minimumInteritemSpacing = 0;
    flowLayout.minimumLineSpacing = 0;
    _collectView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, 0, [UIApplication sharedApplication].keyWindow.bounds.size.width, 200*YZAdapter) collectionViewLayout:flowLayout];
