...
@interface UserGuideViewController () <UIWebViewDelegate, ViewJavaScriptBridgeDelegate, NJKWebViewProgressDelegate>
{
...
- (void) webviewRequest {
    ...
    [self customPushViewControllerNavBarTitle:@"常见问题" backGroundImageName:nil];
    
    self.webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, Screen_W, Screen_H)];
    
    NSString *URLStr = [NSString stringWithFormat:@"%@", HELP];
