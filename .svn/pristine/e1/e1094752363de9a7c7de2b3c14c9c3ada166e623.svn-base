...
extern CGFloat imageHeight = 0.0f;

@implementation YZNewPushThereViewCell
...
//        }
    ...
    [self.ContentImage sd_setImageWithURL:[NSURL URLWithString:PushModel.pic] placeholderImage:nil];
...
//    DLog(@"w = %f,h = %f",image.size.width,image.size.height);
    ...
    imageHeight = 80*YZAdapter;
    
    CGRect ContentImageFrame = self.ContentImage.frame;
    
    ContentImageFrame.size.height = imageHeight;
    self.ContentImage.frame = ContentImageFrame;
    
    self.Content.text = PushModel.content;
    CGRect ContentFrame = self.Content.frame;
    ContentFrame.origin.y = ContentImageFrame.size.height+ContentImageFrame.origin.y+10*YZAdapter;
...
- (UILabel *)Title {
    if (!_Title) {
        ...
        self.Title = [[UILabel alloc] initWithFrame:CGRectMake(16*YZAdapter, 15*YZAdapter, 250*YZAdapter, 16*YZAdapter)];
...
- (UILabel *)Time {
    if (!_Time) {
        ...
        self.Time = [[UILabel alloc] initWithFrame:CGRectMake(265*YZAdapter, 15*YZAdapter, 95*YZAdapter, 16*YZAdapter)];
...
- (UIImageView *)ContentImage {
    if (!_ContentImage) {
        self.ContentImage = [[UIImageView alloc] initWithFrame:CGRectMake(16*YZAdapter, 40*YZAdapter, Screen_W-32*YZAdapter, 16*YZAdapter)];
    }
...
- (UILabel *)Content {
    if (!_Content) {
        ...
        self.Content = [[UILabel alloc] initWithFrame:CGRectMake(16*YZAdapter, 40*YZAdapter, Screen_W-32*YZAdapter, 10*YZAdapter)];
...
- (UILabel *)details {
    if (!_details) {
        ...
        self.details = [[UILabel alloc] initWithFrame:CGRectMake(16*YZAdapter, 80*YZAdapter, 100*YZAdapter, 15*YZAdapter)];
